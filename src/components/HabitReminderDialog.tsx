...
type HabitReminderDialogProps = {
  habit: Habit;
  onSetReminder: (habit: Habit, reminderTime: Date) => void;
};

const HabitReminderDialog = ({ habit, onSetReminder }: HabitReminderDialogProps) => {
  ...
  const handleSetReminder = () => {
    ...
    onSetReminder(habit, reminderDate);
  };
    ...
    <Popover>
      ...
      <PopoverContent className="w-auto p-4" align="end">
        <div className="space-y-4">
          <h4 className="font-medium">Set Habit Reminder</h4>
              ...
              {date && (
                <p>
                  {habit.frequency === "daily" 
                    ? "Daily reminder starting" 
                    : "Weekly reminder starting"} {" "}
                  <strong>
